    ...
    def save = {
        ...
        if(outSrcPurchaseSheetDet.qty>0){
            ...
            if(!result.success){
                ...
                inventoryDetailService.replenish(params.warehouse.id,params.warehouseLocation.id, params.item.id, params.batch.name, outSrcPurchaseSheetDet.qty)
    ...
    def update = {
        ...
        if(outSrcPurchaseSheetDet.qty>0){
            ...
            if(!result.success){
                ...
                if(!inventoryDetailService.consume(outSrcPurchaseSheetDet.warehouse.id,outSrcPurchaseSheetDet.warehouseLocation.id, outSrcPurchaseSheetDet.item.id, outSrcPurchaseSheetDet.batch.name, outSrcPurchaseSheetDet.qty).success){
                    render (contentType: 'application/json') {
