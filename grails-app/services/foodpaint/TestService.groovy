...
class TestService {
    ...
    def createTestMessage = { messageSource ->
        ...
        // messageSource.addMessage("mfg.default.message.update.success", Locale.getDefault(), "更新成功")
        messageSource.addMessage("mfg.default.message.delete.failed", Locale.getDefault(), "刪除失敗")
        messageSource.addMessage("mfg.default.message.not.found", Locale.getDefault(), "查無資料") 

        messageSource.addMessage("mfg.inventory.label", Locale.getDefault(), "庫存")
        messageSource.addMessage("mfg.inventoryDetail.label", Locale.getDefault(), "庫存細項")
        messageSource.addMessage("mfg.customerOrder.label", Locale.getDefault(), "訂單")
        messageSource.addMessage("mfg.customerOrderDet.label", Locale.getDefault(), "訂單單身")
        messageSource.addMessage("mfg.purchaseSheet.label", Locale.getDefault(), "進貨單")
        messageSource.addMessage("mfg.purchaseSheetDet.label", Locale.getDefault(), "進貨單單身")
        messageSource.addMessage("mfg.purchaseReturnSheet.label", Locale.getDefault(), "退貨單")
        messageSource.addMessage("mfg.purchaseReturnSheetDet.label", Locale.getDefault(), "退貨單單身")
        messageSource.addMessage("mfg.manufactureOrder.label", Locale.getDefault(), "製令")
        messageSource.addMessage("mfg.materialSheet.label", Locale.getDefault(), "領料單")
        messageSource.addMessage("mfg.materialSheetDet.label", Locale.getDefault(), "領料單單身")
        messageSource.addMessage("mfg.materialReturnSheet.label", Locale.getDefault(), "退料單")
        messageSource.addMessage("mfg.materialReturnSheetDet.label", Locale.getDefault(), "退料單單身")
        messageSource.addMessage("mfg.stockInSheet.label", Locale.getDefault(), "入庫單")
        messageSource.addMessage("mfg.stockInSheetDet.label", Locale.getDefault(), "入庫單單身")
        messageSource.addMessage("mfg.outSrcPurchaseSheet.label", Locale.getDefault(), "託外進貨單")
        messageSource.addMessage("mfg.outSrcPurchaseSheetDet.label", Locale.getDefault(), "託外進貨單單身")
        messageSource.addMessage("mfg.outSrcPurchaseReturnSheet.label", Locale.getDefault(), "託外退貨單")
        messageSource.addMessage("mfg.outSrcPurchaseReturnSheetDet.label", Locale.getDefault(), "託外退貨單單身")
        messageSource.addMessage("mfg.saleSheet.label", Locale.getDefault(), "銷貨單")
        messageSource.addMessage("mfg.saleSheetDet.label", Locale.getDefault(), "銷貨單單身")
        messageSource.addMessage("mfg.saleReturnSheet.label", Locale.getDefault(), "銷退單")
        messageSource.addMessage("mfg.saleReturnSheetDet.label", Locale.getDefault(), "銷退單單身")

        messageSource.addMessage("mfg.batch.name.params.not.found", Locale.getDefault(), "批號未輸入")
        messageSource.addMessage("mfg.batch.name.unique", Locale.getDefault(), "批號：{0} 已存在，請重新輸入。")
        messageSource.addMessage("mfg.sheet.item.batch.item.not.equal", Locale.getDefault(), " {0} 品項與批號品項不符")
        messageSource.addMessage("mfg.sheet.item.manufactureOrder.item.batch.item.not.equal", Locale.getDefault(), " {0} 品項與製令品項、批號品項不符")
        messageSource.addMessage("mfg.inventory.qty.must.be.more.than.zero", Locale.getDefault(), "數量必須大於0")
        messageSource.addMessage("mfg.inventory.quantity.not.enough", Locale.getDefault(),"{0}、{1} 庫存數量不足")
        messageSource.addMessage("mfg.inventoryDetail.qty.must.be.more.than.zero", Locale.getDefault(), "數量必須大於0")
        messageSource.addMessage("mfg.inventoryDetail.quantity.not.enough", Locale.getDefault(), "{0}、{1}、{2}、{3} 庫存數量不足")
        ...
        messageSource.addMessage("mfg.country.AMERICA.label", Locale.getDefault(), "美國") 
        messageSource.addMessage("mfg.country.AUSTRALIA.label", Locale.getDefault(), "澳洲") 
        messageSource.addMessage("mfg.country.FRENCE.label", Locale.getDefault(), "法國") 
        messageSource.addMessage("mfg.country.BRITAIN.label", Locale.getDefault(), "英國") 
