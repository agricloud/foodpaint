...
grails.project.dependency.resolution = {
    ...
    plugins {
        ...
        build ':tomcat:7.0.54' //build ':tomcat:7.0.50'
        

        // plugins for the compile step
        compile ':scaffolding:2.0.3' //compile ":scaffolding:2.0.0"
        compile ':cache:1.1.1'

        // plugins needed at runtime but not for compilation
        runtime ':hibernate:3.6.10.16' // ':hibernate:3.6.10.7'
        // compile ':hibernate4:4.1.11.4'
        runtime ':database-migration:1.4.0' //runtime ":database-migration:1.3.8"
        runtime ":jquery:1.10.2"
        runtime ':resources:1.2.8' //runtime ":resources:1.2"
