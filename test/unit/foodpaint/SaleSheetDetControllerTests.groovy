...
class SaleSheetDetControllerTests {
    ...
    void testUpdate() {
        ...
        def inventoryDetail2 = new InventoryDetail(warehouse:warehouse1,storageLocation:storageLocation1,item:item2,batch:batch2,qty:500).save(failOnError: true, flush: true)
        ...
        assert InventoryDetail.findByWarehouseAndStorageLocationAndItemAndBatch(warehouse1,storageLocation1,item2,batch2).qty==0
    }
